        ...
        <section class="d-flex flex-column gap-3">
            ...
            <div class="d-flex justify-content-center">
                <div class="container position-sticky top-0 py-3" style="max-width: 50%;">
                    ...
                    <!-- Form Upload -->
                    <form action="{{ route('albumAdd') }}" method="POST" class="row g-3 mt-3" enctype="multipart/form-data">
                        @csrf
                        <div class="col-12">
                            <label class="form-label" for="judul">Judul</label>
                            <input type="text" name="judul" id="judul" class="form-control" placeholder="Judul Album" />
                        </div>
